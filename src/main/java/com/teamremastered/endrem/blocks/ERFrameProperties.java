...
public enum ERFrameProperties implements StringRepresentable {
    ...
    public String getSerializedName() {
        return switch (this) {
            ...
            case OMINOUS_EYE -> "ominous_eye";
            case AETHER_EYE -> "aether_eye";
            case AMBER_EYE -> "amber_eye";
            case ARCHAIC_EYE -> "archaic_eye";
            case QUEENS_EYE -> "queens_eye";
            case BLOSSOM_EYE -> "blossom_eye";
            case ELDRITCH_EYE -> "eldritch_eye";
        };
    }
